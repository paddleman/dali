defmodule DaliWeb.ProjectLiveTest do
  use DaliWeb.ConnCase

  import Phoenix.LiveViewTest
  import Dali.ProjectsFixtures

  @create_attrs %{status: "some status", project_number: "some project_number", project_name: "some project_name", start_date: "2024-05-17", end_date: "2024-05-17"}
  @update_attrs %{status: "some updated status", project_number: "some updated project_number", project_name: "some updated project_name", start_date: "2024-05-18", end_date: "2024-05-18"}
